...
def pagina_chat():
    ...
    # Exibe mensagens de progresso no chat (sem aninhar chat_message!)
...
def sidebar():
    ...
    if arquivo is not None:
        ...
        try:
            ...
            # Salva no session_state (chat usa isso)
