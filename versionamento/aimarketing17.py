...
def main():
    ...
    st.markdown(
        "Aqui, a Inteligência Artificial transforma seus dados em **tabelas, insights e conteúdos** para comunicação.\n"
    )
    ...
    if arquivo:
        ...
        with st.spinner("🔄 Rodando ETL ILUMEO..."):
            ...
            try:
                ...
                st.success("ETL concluído! JSON carregado e tabelas geradas.")
        ...
        # --------------------------------------------------------------
        st.subheader("📊 Tabelas de Frequência para Exploração")
