...
def pagina_chat():
    ...
    if "df" in st.session_state:
        ...
        # Botão de execução fora dos blocos de chat_message
...
def sidebar():
    ...
    tipo_analise = st.selectbox("Selecione o tipo de análise desejada:", TIPOS_ANALISE)
